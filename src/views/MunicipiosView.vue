<template>
    <div class="container mt-3">
        <div class="mt-4 w-100 d-flex">
            ...
            <h2 style="margin: 0px;">{{ $route.params.estado }}</h2>
        </div>
        <span style="margin-left: 44px; color: #9c9c9c;">Regiões/{{ $route.params.regiao }}/{{ $route.params.estado }}</span>
        ...
        <div class="table-responsive-sm mt-3 px-5">
            ...
            <tbody>
                <tr>
                    <td>
                        <RouterLink  aria-current="page" :to="`/regioes/${$route.params.regiao}/${$route.params.estado}/Recife`" style="text-decoration: none;">Recife</RouterLink>
                    </td>
                    <td>3.245</td>
                    <td>245</td>
                </tr>
